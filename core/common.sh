...
show_help() {
    ...
    echo -e "  ${GREEN}whitelist${NC} [command]   Manage preferred nodes/farms (interactive or direct)"
    echo -e "      (no args)             Interactive menu for add/remove/view/clear"
    echo -e "      nodes <ids>           Set preferred node IDs (e.g., '920,891')"
    echo -e "      farms <names>         Set preferred farm NAMES (e.g., 'FastFarm,PremiumHost')"
    echo -e "      --status              Show current whitelist"
    echo -e "      --clear               Clear all whitelist entries"
    echo -e "  ${GREEN}blacklist${NC} [command]   Manage nodes/farms to avoid (interactive or direct)"
    echo -e "      (no args)             Interactive menu for add/remove/view/clear"
    echo -e "      nodes <ids>           Set nodes to avoid (e.g., '615,888')"
    echo -e "      farms <names>         Set farm NAMES to avoid (e.g., 'BadFarm,Problematic')"
    ...
    echo "  tfgrid-compose whitelist farms 'Fast Farm,Happy Hosting'  # Set preferred farm NAMES"
    echo "  tfgrid-compose blacklist farms ProblematicFarm   # Avoid problematic farm NAME"
