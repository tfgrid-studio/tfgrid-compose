...
show_help() {
    ...
    echo -e "      --ipv4, -4         Force IPv4 network"
    echo -e "      --mycelium, -m     Force Mycelium network"
    echo -e "      --wireguard, -w    Force WireGuard network"
    echo -e "      --ipv6             Force IPv6 network"
    ...
    echo -e "      ${GREEN}test${NC}               Test connectivity to all networks"
    echo ""
